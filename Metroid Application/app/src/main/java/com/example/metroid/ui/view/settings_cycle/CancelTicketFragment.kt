    ...
    private fun changeLayout() {
        try {
            if (ticketInfoData.message == 1) {
                fragmentCancelTicketBinding.tvPrice.text = "${ticketInfoData.price} L.E"
                fragmentCancelTicketBinding.tvStateFrom.text = ticketInfoData.stateArr
                fragmentCancelTicketBinding.tvStateTo.text = ticketInfoData.stateDept
                fragmentCancelTicketBinding.tvUserName.text = ticketInfoData.firstName
                fragmentCancelTicketBinding.tvStationFromName.text = ticketInfoData.nameArr
                fragmentCancelTicketBinding.tvStationToName.text = ticketInfoData.nameDept
                fragmentCancelTicketBinding.tvSeats.text = ticketInfoData.seats.toString()
                fragmentCancelTicketBinding.tvTripId.text = ticketInfoData.tripId.toString()


                fragmentCancelTicketBinding.tvConfirmedAt.text = ticketInfoData.confirmDate
                ...
                fragmentCancelTicketBinding.tvArrCalender.text = formatDateTime
                fragmentCancelTicketBinding.tvDeptCalender.text = formatDateTime2
